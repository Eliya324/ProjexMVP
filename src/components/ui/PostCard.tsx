...
function PostHeader({ post, isCompact }: { post: Post; isCompact?: boolean }) {
  return isCompact ? (
    <div className="flex items-start gap-2 px-4 pt-4">
      <div className="w-[50px] h-[50px] sm:w-[50px] sm:h-[50px] max-sm:w-[60px] max-sm:h-[60px] min-w-[50px] flex-shrink-0">
        <Image
...
export default function PostCard({
  ...
  if (isCompact) {
    return (
      <Card
        className={`sm:w-[290px] max-sm:w-[100%]  max-sm:h-auto sm:min-h-[368px]  flex flex-col rounded-2xl shadow-md border border-gray-200 transition-all duration-300 border-blue-light
  ...
  return (
    <Card className="w-full max-sm:w-[90%] mx-auto  max-w-3xl bg-white rounded-[20px] border border-black p-6 shadow-md mt-6 flex flex-col justify-between">
